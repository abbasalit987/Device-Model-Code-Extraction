...
df = pd.read_excel(
    "component_warranty_model/Data/Haier/extracted_models_haier.xlsx",
    sheet_name="Extracted Models 002",
)
...
unmatched_df.to_excel(
    "component_warranty_model/Data/Haier/unmatched_cases.xlsx", index=False
)
