...
df = pd.read_excel("component_warranty_model/Data/LG/extracted_models_lg.xlsx", sheet_name='Extracted Models 004')
...
unmatched_df.to_excel("component_warranty_model/Data/LG/unmatched_cases.xlsx", index=False)
...
nlp.to_disk("component_warranty_model/spaCy/LG/fine_tune_model")
print("Training completed successfully for LG Models!")
