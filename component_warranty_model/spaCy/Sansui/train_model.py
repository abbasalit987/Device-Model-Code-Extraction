...
df = pd.read_excel("component_warranty_model/Data/Sansui/extracted_models_sansui.xlsx", sheet_name='Extracted Models 004')
...
unmatched_df.to_excel("component_warranty_model/Data/Sansui/unmatched_cases.xlsx", index=False)
...
nlp.to_disk("component_warranty_model/spaCy/Sansui/fine_tune_model")
print("Training completed successfully for Sansui Models!")
