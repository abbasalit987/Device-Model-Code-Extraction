...
df = pd.read_excel("component_warranty_model/Data/Samsung/extracted_models_samsung.xlsx", sheet_name='Extracted Models 001')
...
print("Training completed successfully for Samsung Models!")
