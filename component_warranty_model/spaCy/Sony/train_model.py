...
df = pd.read_excel("component_warranty_model/Data/Sony/extracted_models_sony.xlsx", sheet_name='Extracted Models 007')
...
print("Training completed successfully for Sony Models!")
